...
tools.append(
    Tool(
        ...
        description="""
        Useful for finding the uppermost bedrock geology at a given point location represented by a latitude and longitude. Not good for regional geology.
        The input to this tool should be a comma separated list of numbers of length two,representing latitude and longitude. 
        For example, `40.7128,-74.0060` would be the input for a location at latitude 40.7128 and longitude -74.0060
        """,
    ),
...
agent_prompt_string_1 = """
          As a professor leading a field trip, describe to students how the uppermost surface geology at the local point location at center of _______ . 
...
filepath = "../experiments/results_of_tests/experiment_results_agentB.json"  
