...
def callChatGPT4(inputString:str):
    ...
    request = "What is the geologic story around "+location+" ? Be sure to discuss the youngest uppermost rocks that range from "+yearsOld+" million years old. Break it down by time period and < 9 sentences."
...
tools.append(
    Tool(
        ...
        The input to this tool needs tos be a comma separated list of numbers of length two. The numbers should represent latitude and longitude. No W or N included only numbers.
        For example, `40.7128,-74.0060` would be the input for a location at latitude 40.7128 and longitude -74.0060
        """,
    ),
)
...
agent_prompt_string_1 = """
          Describe the uppermost surface geology at the local point location at center of _______ . 
          ...
          Be sure to mention the rock's age, composition, and thickness. Only if lithology is sedimentary should the interpreted depositional environment be mentioned. Do not add percentages!
...
agent_prompt_string_2 = """
          ...
          You do not need to repeat any of those rocks again! If you mention rocks of the same age, refer back to them like 'as mentioned before.'
          Now start from the end of that statement and describe to students the regional geology around  _______ . If the location is not well known, you may need to find latitude and longitude the approximates the center point.
          Start with the phrase 'Now stepping back to talk about the regional geology around this area'
          Break it down by time period in narrative fashion over 8-12 sentences that flow from what you previously said about the outcrop geology of point location starting with oldest.
          """       
          
          
filepath = "../experiments/results_of_tests/experiment_results_agentD.json"  
...
#print(combinedAnswerArray[0]["geology_response"],combinedAnswerArray[1]["geology_response"])
